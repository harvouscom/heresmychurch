...
// /state/:stateAbbrev          → State view (US alias, kept for existing links)
// /country/:cc                 → Country overview (e.g. /country/CA)
// /country/:cc/:regionCode     → Region view (e.g. /country/CA/PE)
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // Country-scoped browsing. /state/:abbrev stays as the US alias so every
      // existing link, sitemap entry and shared URL keeps working.
