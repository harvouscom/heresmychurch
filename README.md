...
**Frontend:** [React](https://react.dev) 18, [TypeScript](https://www.typescriptlang.org), [Vite](https://vite.dev), [React Router](https://reactrouter.com) v7 · **Styling:** [Tailwind](https://tailwindcss.com) v4, [shadcn/ui](https://ui.shadcn.com), [Radix](https://www.radix-ui.com), [Lucide](https://lucide.dev), [Motion](https://motion.dev) · **Mapping:** [MapLibre GL](https://maplibre.org) (Web Mercator; free CARTO vector tiles, no API key), [d3-geo](https://d3js.org/d3-geo), [TopoJSON](https://github.com/topojson/topojson) · [react-simple-maps](https://www.react-simple-maps.io) remains for the seasonal-report charts · **Backend:** [Supabase](https://supabase.com), [Hono](https://hono.dev)
